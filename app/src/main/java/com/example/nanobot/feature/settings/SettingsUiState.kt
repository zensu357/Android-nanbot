...
data class SettingsDraftState(
    ...
    val maxSubagentDepth: String = "3",
    val maxParallelSubagents: String = "4",
    ...
    val enableTaskPlanning: Boolean = true,
    val enableBehaviorLearning: Boolean = true,
...
data class SettingsUiState(
    ...
    val maxSubagentDepth: String get() = draft.maxSubagentDepth
    val maxParallelSubagents: String get() = draft.maxParallelSubagents
    ...
    val enableTaskPlanning: Boolean get() = draft.enableTaskPlanning
    val enableBehaviorLearning: Boolean get() = draft.enableBehaviorLearning
...
fun SettingsBaselineState.toDraftState(): SettingsDraftState {
    return SettingsDraftState(
        ...
        maxSubagentDepth = config.maxSubagentDepth.toString(),
        maxParallelSubagents = config.maxParallelSubagents.toString(),
        ...
        enableTaskPlanning = config.enableTaskPlanning,
        enableBehaviorLearning = config.enableBehaviorLearning,
...
fun SettingsDraftState.toAgentConfig(): AgentConfig {
    return AgentConfig(
        ...
        maxSubagentDepth = maxSubagentDepth.toIntOrNull() ?: 3,
        maxParallelSubagents = maxParallelSubagents.toIntOrNull() ?: 4,
